...
// // Props definition for CanvasRevealEffect component
...
// // Props definition for DotMatrix component
// interface DotMatrixProps {
//   colors?: number[][];
//   opacities?: number[];
//   totalSize?: number;
...
// // Type definitions for ShaderMaterial component props
// interface Uniforms {
//   [key: string]: {
//     value: number[] | number[][] | number;
//     type: string;
...
//           fragCoord = coordinates * u_resolution * 0.5 + u_resolution * 0.5;
//         }`,
//       fragmentShader: source,
//       uniforms: getUniforms(),
//       transparent: true,
...
//         void main() {
//           fragCoord = uv * 100.0; // Adjusted scaling
...
// // Shader component to render the ShaderMaterial
// const Shader: React.FC<{
//   source: string;
//   uniforms: Uniforms;
//   maxFps?: number;
